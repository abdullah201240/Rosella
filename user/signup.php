    ...
    <section class="checkout spad">
        <div class="container auth-container">
            ...
            <div class="checkout__form">
                <form method="POST" action="signup.php<?php echo isset($_GET['redirect']) ? '?redirect=' . urlencode($_GET['redirect']) : ''; ?>">
                    ...
                    <a href="login.php<?php echo isset($_GET['redirect']) ? '?redirect=' . urlencode($_GET['redirect']) : ''; ?>" class="site-btn" style="margin-left:10px;background:#6c757d;">Login</a>
                </form>
            </div>
        </div>
    </section>
