                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td><img src="../uploads/<?php echo $row['image']; ?>" alt="Product Image" width="50" height="50"></td>
                                <td>
                                        ...
                                        <div class="modal-body">
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="productCode" value="<?php echo $row['product_code']; ?>" required>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">Weight:</label>
                                                    <input type="number" class="form-control" name="weight" value="<?php echo $row['weight']; ?>" required>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">Care Note:</label>
                                                    <textarea class="form-control" name="careNote" required><?php echo $row['care_note']; ?></textarea>
                                                </div>
